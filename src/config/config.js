...
export default {
  ...
  steps: [
    { stepName: rejectionPageName.rejectionNotLimitedCompany, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.refer, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionCompanyType, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionNotSME, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionQuoteRequest, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionCustomerAlreadyExist, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionFullDecision, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectionQuoteError, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectedWrongDetails, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.rejectedMoreThan1Director, excludeModules: ['ProgressBar'] },
    { stepName: rejectionPageName.fundingOptionsReferral, excludeModules: ['ProgressBar'] },
    { stepName: stepName.businessTypeSelection, default: true, excludeModules: ['ProgressBar'] },
    { stepName: stepName.instantQuote1, progressBarStep: stepName.instantQuote1 },
    { stepName: stepName.instantQuote2, progressBarStep: stepName.instantQuote1 },
    { stepName: stepName.instantQuote3, progressBarStep: stepName.instantQuote1 },
    { stepName: stepName.instantQuote4, progressBarStep: stepName.instantQuote1 },
    { stepName: stepName.approvedQuote, progressBarStep: stepName.approvedQuote },
    { stepName: stepName.marketingPreferences, progressBarStep: stepName.approvedQuote },
    { stepName: stepName.createUser, progressBarStep: stepName.approvedQuote },
    { stepName: stepName.aboutYourBusiness1, progressBarStep: stepName.aboutYourBusiness1 },
    { stepName: stepName.aboutYourBusiness2, progressBarStep: stepName.aboutYourBusiness1 },
    { stepName: stepName.moreAboutYou, progressBarStep: stepName.moreAboutYou },
    { stepName: stepName.idVerification, progressBarStep: stepName.idVerification },
    { stepName: stepName.bankDetails, progressBarStep: stepName.idVerification },
